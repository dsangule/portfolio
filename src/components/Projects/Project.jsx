...
function Project({item}) {
  return (
    <div className="bg-black flex flex-col md:flex-row text-white rounded-md md:h-60">
      <Image src={item.imgsrc} alt="Project image" height={500} width={500} className="w-[100%] h-[100%] md:max-w-96 md:min-w-96 mr-2 rounded-md" />
      <div className="p-4 pr-6 flex flex-col w-full">
        ...
        <div className="mt-4">
          ...
          <Image src={"/GitHub.svg"} alt="Github icon" height={300} width={300} className="w-6" />
